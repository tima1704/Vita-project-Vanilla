document.addEventListener("DOMContentLoaded", () => {
  const translations = {
    ru: {
      ...
      homeHeader: "Витамаркет предлагает Вам  широкий ассортимент качественных витаминов и биологически активных добавок, которые помогут вам поддерживать здоровье, улучшить самочувствие и повысить уровень энергии.",
    ...
    en: {
      ...
      homeHeader: "VitaMarket  offers a wide range of quality vitamins and dietary supplements that will help you maintain your health, improve your well-being, and boost your energy levels.",
      homeSubHeader: " Our goal is to make caring for your health accessible and convenient.",
